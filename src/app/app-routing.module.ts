...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'clients', loadComponent: () => import('./demo/pages/clients/clients.component').then((c) => c.ClientsComponent) },
      { path: 'users', loadComponent: () => import('./demo/pages/users/users.component').then((c) => c.UsersComponent) },
      {
        path: 'forms',
